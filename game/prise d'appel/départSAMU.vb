...
Public Class départSAMU
    ...
    Public Sub actualiserSAMU()


        ListBox1.Items.Clear()
        ListBox1.UseCustomTabOffsets = True
        ListBox1.CustomTabOffsets.Add(40)
        ListBox1.CustomTabOffsets.Add(65)
        ListBox1.CustomTabOffsets.Add(165)
        ...
        Try
            ...
            For Each Repertoires As DirectoryInfo In New DirectoryInfo(pluginLoaded & "\center\samu\").GetDirectories()
                ...
                Dim lat_centre As Double = Convert.ToDouble(Cls_Ini.INIRead(pluginLoaded & "\center\samu\" & Repertoires.Name & "\center.ini", "info", "lat"), ciClone)
                Dim lon_centre As Double = Convert.ToDouble(Cls_Ini.INIRead(pluginLoaded & "\center\samu\" & Repertoires.Name & "\center.ini", "info", "lon"), ciClone)
                ...
                If d < 1000 Then
                    Try
                        For Each Fichier As FileInfo In New DirectoryInfo(pluginLoaded & "\center\samu\" & Repertoires.Name & "\moyens\").GetFiles()
                            ListBox1.Items.Add(resultat & " km" & vbTab & "SAMU" & vbTab & Repertoires.Name & vbTab & Cls_Ini.INIRead(pluginLoaded & "\center\samu\" & Repertoires.Name & "\moyens\" & Fichier.Name, "info", "name"))
                        Next
