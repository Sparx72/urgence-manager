...
Public Class départDIR
    ...
    Public Sub actualiserDIR()
        ...
        Try
            ...
            For Each Repertoires As DirectoryInfo In New DirectoryInfo(pluginLoaded & "\center\dir\").GetDirectories()
                ...
                Dim lat_centre As Double = Convert.ToDouble(Cls_Ini.INIRead(pluginLoaded & "\center\dir\" & Repertoires.Name & "\center.ini", "info", "lat"), ciClone)
                Dim lon_centre As Double = Convert.ToDouble(Cls_Ini.INIRead(pluginLoaded & "\center\dir\" & Repertoires.Name & "\center.ini", "info", "lon"), ciClone)
                ...
                If d < 1000 Then
                    Try
                        For Each Fichier As FileInfo In New DirectoryInfo(pluginLoaded & "\center\dir\" & Repertoires.Name & "\moyens\").GetFiles()
                            ListBox1.Items.Add(resultat & " km" & vbTab & "DIR" & vbTab & Repertoires.Name & vbTab & Cls_Ini.INIRead(pluginLoaded & "\center\dir\" & Repertoires.Name & "\moyens\" & Fichier.Name, "info", "name"))
                        Next
