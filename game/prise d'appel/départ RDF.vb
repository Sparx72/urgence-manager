...
Public Class départRDF
    ...
    Public Sub actualiserRDF()
        ...
        Try
            ...
            For Each Repertoires As DirectoryInfo In New DirectoryInfo(pluginLoaded & "\center\rdf\").GetDirectories()
                ...
                Dim lat_centre As Double = Convert.ToDouble(Cls_Ini.INIRead(pluginLoaded & "\center\rdf\" & Repertoires.Name & "\center.ini", "info", "lat"), ciClone)
                Dim lon_centre As Double = Convert.ToDouble(Cls_Ini.INIRead(pluginLoaded & "\center\rdf\" & Repertoires.Name & "\center.ini", "info", "lon"), ciClone)
                ...
                If d < 1000 Then
                    Try
                        For Each Fichier As FileInfo In New DirectoryInfo(pluginLoaded & "\center\rdf\" & Repertoires.Name & "\moyens\").GetFiles()
                            ListBox1.Items.Add(resultat & " km" & vbTab & "RDF" & vbTab & Repertoires.Name & vbTab & Cls_Ini.INIRead(pluginLoaded & "\center\rdf\" & Repertoires.Name & "\moyens\" & Fichier.Name, "info", "name"))
                        Next
