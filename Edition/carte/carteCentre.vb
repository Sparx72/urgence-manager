...
Module carteCentre
    ...
    Public Sub afficherCarteCentre()
        ...
        Dim sw As New StreamWriter(appdata & "cache/" & "carteCentre.html", False, System.Text.Encoding.UTF8)
        ...
        If centreIncendieSecours.FlatLabel8.Text <> "-" And centreIncendieSecours.FlatLabel9.Text <> "-" Or centreIncendieSecours.FlatLabel8.Text <> "" And centreIncendieSecours.FlatLabel9.Text <> "" Then

            latDefaut = centreIncendieSecours.FlatLabel9.Text
            lonDefaut = centreIncendieSecours.FlatLabel8.Text
            zoom = "16"
        ...
        sw.WriteLine("#map{")
        sw.WriteLine("height:" & centreIncendieSecours.WebBrowser2.Height - 22 & "px;")
        ...
        centreIncendieSecours.WebBrowser2.Navigate(appdata & "cache/" & "carteCentre.html")
    End Sub
